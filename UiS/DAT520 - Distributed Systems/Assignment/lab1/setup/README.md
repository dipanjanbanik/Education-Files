...
If you are running Windows, please consult the instructions [here](https://github.com/dat520-2022/info/blob/main/setup-wsl.md).
...
Below we use `git@github.com:dat520-2022/username-labs.git` as an example.

```console
# clone the Git repo with SSH into the $HOME/assignments directory
git clone git@github.com:dat520-2022/username-labs.git assignments
cd assignments
git remote add course-assignments https://github.com/dat520-2022/assignments.git
...
Read our [lab submission guide](https://github.com/dat520-2022/info/blob/main/lab-submission.md) for more detailed instructions on how to submit your assignments to be evaluated by QuickFeed.
