...
5. If the remote repositories are set up as in the following segment, how would you pull changes from the `dat520-2022/assignments` repo into the `dat520-2022/student-labs` repo you are working in?

    ```console
    course-assignments  git@github.com:dat520-2022/assignments.git (fetch)
    course-assignments  git@github.com:dat520-2022/assignments.git (push)
    origin              git@github.com:dat520-2022/student-labs.git (fetch)
    origin              git@github.com:dat520-2022/student-labs.git (push)
    ```

    - [ ] a) `git pull dat520-2022/assignments.git dat520-2022/student-labs.git`
