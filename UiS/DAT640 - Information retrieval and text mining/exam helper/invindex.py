...
def words_stemming(words):
    """
    Remove suffix and stemming word
    """
    stemmed_words = []
...
if __name__ == "__main__":
    ...
    doc1 = "The old man and his two sons went fishing."
    doc2 = "Recreational fishing is an activity with important social implications."
    doc3 = "Introduction to social protection benefits for old age"
    doc4 = "Introduction to how lake trout fishing works"

    # Build Inverted-Index for documents
    inverted = {}
    documents = {"doc1": doc1, "doc2": doc2, "doc3": doc3, "doc4": doc4}
    ...
    # print(dict(sorted(inverted.items())))
    print("----------------------")
    for x in dict(sorted(inverted.items())):
        print(x, "->", inverted[x])
